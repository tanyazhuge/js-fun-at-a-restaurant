...
if (isFavorite===true){
  console.log(`My favortie food is ${food}.`)
} else {
...
var vegetables = ["onions", "carrots", "cabbages", "tomatoes", "potatoes"]
...
// different fruits.
var fruits = ["apples", "oranges", "grapes", "peaches", "strawberries", "plum", "blueberries"]
