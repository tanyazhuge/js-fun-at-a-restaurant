...
function addMenuItem(newRestaurant, foodItemInfo) {
  ...
  if ("breakfast" === foodItemInfo.type && newRestaurant.menus.breakfast.includes(foodItemInfo) === false) {
    newRestaurant.menus.breakfast.push(foodItemInfo);

  } else if ("lunch" === foodItemInfo.type && newRestaurant.menus.lunch.includes(foodItemInfo) === false) {
    newRestaurant.menus.lunch.push(foodItemInfo);

  } else if ("dinner" === foodItemInfo.type && newRestaurant.menus.dinner.includes(foodItemInfo) === false) {
